...
namespace Task3.Tests
{
    ...
    public class MonitorTests
    {
        ...
        {
            Monitor monitor0 = new Laptop("Gl a2", 130);
            Monitor monitor1 = new Laptop("Gl a3", 150);
        ...
        {
            Monitor monitor = new Laptop("Gl a2", 130);
            Scales scales = monitor;
        ...
        {
            Monitor monitor = new Laptop("Gl a2", 130);
            BreadMachine breadMachine = monitor;
