...
namespace Figures.Tests
{
    ...
    public class CircleTests
    {
        ...
        [TestMethod()]
        public void CreateCircleFromAnotherFigureTest()
        {
            Figure rectangle = new Rectangle(5, 2);
            Assert.IsNotNull(new Circle(1.78, rectangle));
            Assert.ThrowsException<CuttingException>(() => new Circle(1.80, rectangle));
        }
