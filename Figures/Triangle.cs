...
namespace Figures
{
    public class Triangle : Figure
    {
        ...
        /// <summary>
        /// Constructor for cutting a triangle with 
        ...
        public Triangle(double a, double b, double c, Figure figure) : this(a, b, c)
        {
            if (Area() > figure.Area())
            {
                throw new CuttingException("Can't cut a triangle with a given sides from this figure");
            }
        }

        /// <summary>
        /// Constructor for cutting a triangle by 
        ...
        /// <param name="p3">3rd top coords</param>
        /// <param name="figure">figure to cut</param>
        public Triangle(PointF p1, PointF p2, PointF p3, Figure figure) : this(p1, p2, p3)
        {
            if (Area() > figure.Area())
            {
                throw new CuttingException("Can't cut a triangle with a given vertex coordinates from this figure");
            }
        }
        ...
        { 
            return $"Triangle {Side1Length} {Side2Length} {Side3Length}"; 
        }
        ...
        { 
            return (Side1Length.GetHashCode() << 3) ^ (Side2Length.GetHashCode() << 2) ^ Side3Length.GetHashCode(); 
        }
